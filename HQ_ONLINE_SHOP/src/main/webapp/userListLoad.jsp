...
<!--                             <th>Password</th> -->
                    ...
                    <tbody>
                    	<c:forEach var="user" items="${userList}">
                    		...
                    		<c:param name="mode" value="TEMP"></c:param>
                    	...
                    	<tr>
      		           ...
      		           <%-- <td><c:out value="${user.password}"></c:out></td> --%>
                            ...
                            <td><a href="${updatelink}" class="btn btn-primary">Edit</a></td>
                           	<td><a href="${deleteLink}" id="delete" class="btn btn-danger" onclick="return confirm('Are you sure to delete this user?;')">Delete</a></td>
                        </tr>
                    	</c:forEach>
                    </tbody>
                </table>
